...
# Configuration — all paths are resolved relative to api.py
...
DEVANAGARI_MAP = {**CONSONANTS, **VOWELS, **NUMBERS, **SYMBOLS}
...
app = FastAPI(title="Ranjana Monogram API")
...
async def generate_monogram(req: MonogramRequest):
    ...
    if not re.search(r'[\u0900-\u097F]', text):
        ...
        translit_map = {**CONSONANTS, **VOWELS, **NUMBERS, **SYMBOLS}
        matra_map = MATRAS
